...
namespace DbFrame.Class
{
    ...
    public class TableInfo
    {
        ...
        public static Entity_Table Get<T>(T _Entity) where T : class,new()
        {
            var _Entity_Table = new Entity_Table();
            var _TableAttr = ReflexHelper.GetTableAttribute(_Entity.GetType());
            _Entity_Table.TableName = _TableAttr == null ? _Entity.GetType().Name : _TableAttr.TableName;
            var _Fields = ReflexHelper.GetPropertyInfos(_Entity.GetType());
